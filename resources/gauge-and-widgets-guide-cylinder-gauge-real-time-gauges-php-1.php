<?php
//This page is meant to showcase real-time update from server.
...
if(!isset($_SESSION['cylinder-real-time-fuelVolume-1']))
{
	$_SESSION["cylinder-real-time-fuelVolume-1"] = 110 ;
}
